...
Visual mode lets you select text explicitly and then apply operators to the selection. Text objects are usually faster, but Visual mode is more intuitive and indispensable for certain jobs — especially column editing.
