...
Motions get you to the right neighborhood. Search drops you on the doorstep. Once `/` and `f` are in your fingers, you stop counting `j`s and `w`s and just go straight to the thing you're looking at. Two flavors here: search across the file, and search within the line. You'll reach for both constantly.
