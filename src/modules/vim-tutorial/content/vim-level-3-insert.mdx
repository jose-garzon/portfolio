...
You've learned to navigate. Now it's time to write. Vim gives you several ways to enter Insert mode, each placing the cursor in a slightly different spot. Picking the right one means fewer keystrokes.
