...
Commenting and uncommenting code is something you do constantly. Vim has no native comment toggle, but the `commentary.vim` plugin (Vim) or `Comment.nvim` (Neovim) adds it so seamlessly it feels built-in.
